"""Studenti_oblik URL Configuration
...
from students.views import students_list, students_add, students_edit, students_delete, \
    groups_list, groups_add, groups_edit, groups_delete
